export const topicsIlike = ['TP1', 'TP2', 'TP3', 'TP5', 'TP7']
export const MY_TUITS = [
...
export const oldest = All_TUITS.reduce((max, tuit)=>{
  if(tuit.old > max) {return tuit.old;}
  else {return max;}
}, 0);
export const youngest = All_TUITS.reduce((min, tuit)=>{
